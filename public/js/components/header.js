  ...
  render(container) {
    container.innerHTML = `
      <header id="app-header" class="bg-surface border-b border-border h-12 px-4 flex items-center justify-between select-none">
        ...
        <div class="flex items-center space-x-2">
          <button id="btn-jump-to-build" title="Builder" class="btn-secondary w-7 h-7 p-0 flex items-center justify-center hover:bg-white/5 text-zinc-300 rounded-md transition active:scale-95">
